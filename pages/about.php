	<!-- END nav -->
	<section class="hero-wrap hero-wrap-2" style="background-image: url('./public/images/bg_2.jpg');"
		data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="container">
			<div class="row no-gutters slider-text align-items-end">
				<div class="col-md-9 ftco-animate pb-5">
					<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php?page=home">Início <i
			...
			<div class="row d-flex">
				<div class="col-md-12 d-flex ftco-animate">
					<div class="blog-entry align-self-stretch">
						...
						<div class="text p-0">
							<div class="meta mb-1">
								<div><a href="#" class="meta-chat"><span class="fa fa-comment"></span></div>
								<div class="heading">
									<h4>O Amparo nasceu do amor incondicional pelos animais e da vontade de transformar
										vidas.
										Acreditamos que todo pet merece cuidado, carinho e um lar seguro.
										Nossa missão é acolher, tratar e encontrar famílias amorosas para aqueles que
										foram abandonados ou
										vivem em situação de
										risco.
										Com o apoio de doações e voluntários, tornamos possível essa corrente de amor.
										Juntos, podemos mudar histórias. </h4>
								</div>
							</div>
						</div>
					</div>
